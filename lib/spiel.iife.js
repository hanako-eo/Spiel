var Spiel = (function (exports) {
	...
	***************************************************************************** */
	...
	var EventEmitter = /** @class */ (function () {
	    ...
	    EventEmitter.emit = function (event) {
	        ...
	        if (!(event in this.events))
	            return false;
	        (_a = this.events)[event].apply(_a, tslib_1.__spread(args));
	        return true;
	    };
	...
	var require$$3 = getCjsExportFromNamespace(contro_esm);

	var app = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });

	var EventEmitter_1 = tslib_1.__importDefault(EventEmitter_1$1);
	var InvisibleClass_1 = tslib_1.__importDefault(InvisibleClass_1$1);
	var uniformFunction_1 = tslib_1.__importDefault(uniformFunction$1);
	var contro_1 = tslib_1.__importDefault(require$$3);
	...
	var FPSPlugin = /** @class */ (function (_super) {
	    tslib_1.__extends(FPSPlugin, _super);
	    function FPSPlugin() {
	...
	var Game = /** @class */ (function () {
	    ...
	    Game.prototype.setEntity = function (o, scene, entityName, l) {
	        ...
	        if (!(entity instanceof Entity.Camera) && entityName !== "@camera") {
	            ...
	            entity.changeScene = function (name) {
	                ...
	                if (_this.sceneId !== -1 && "toScene" in _this.scenes[_this.sceneId] === false || _this.scenes[_this.sceneId].toScene(_this.use)) {
	                    ...
	                    try {
	                        for (var _b = tslib_1.__values(_this.plugins), _c = _b.next(); !_c.done; _c = _b.next()) {
	                            var plugin = _c.value;
	            ...
	            if (l instanceof HTMLImageElement) {
	                ...
	                entity.collide = function (entity, border) {
	                    ...
	                    var side = "none";
	                    if (border !== null) {
	                        var top = this.x < scene.entity[entity].x + (scene.entity[entity].entityWidth * scene.entity[entity].scale) &&
	                        ...
	                        var left = this.x < scene.entity[entity].x + (border * scene.entity[entity].scale) &&
	                            this.x + this.entityWidth > scene.entity[entity].x &&
	                            this.y < scene.entity[entity].y + (scene.entity[entity].entityHeight * scene.entity[entity].scale) &&
	                            this.y + this.entityHeight > scene.entity[entity].y;
	                        var bottom = this.x < scene.entity[entity].x + (scene.entity[entity].entityWidth * scene.entity[entity].scale) &&
	                            this.x + this.entityWidth > scene.entity[entity].x &&
	                            this.y < scene.entity[entity].y + (scene.entity[entity].entityHeight * scene.entity[entity].scale) &&
	                        ...
	                        var right = this.x < scene.entity[entity].x + (scene.entity[entity].entityWidth * scene.entity[entity].scale) - (border * scene.entity[entity].scale) &&
	                            this.x + this.entityWidth > scene.entity[entity].x + (scene.entity[entity].entityWidth * scene.entity[entity].scale) &&
	                            this.y < scene.entity[entity].y + (scene.entity[entity].entityHeight * scene.entity[entity].scale) &&
	                            this.y + this.entityHeight > scene.entity[entity].y;
	                        var inside = this.x < scene.entity[entity].x + (scene.entity[entity].entityWidth * scene.entity[entity].scale) &&
	                            this.x + this.entityWidth > scene.entity[entity].x &&
	                            this.y < scene.entity[entity].y + (scene.entity[entity].entityHeight * scene.entity[entity].scale) &&
	                            this.y + this.entityHeight > scene.entity[entity].y;
	                        ...
	                        var top = this.x < scene.entity[entity].x + scene.entity[entity].body.x + scene.entity[entity].body.width &&
	                        ...
	                        var left = this.x < scene.entity[entity].x + 1 &&
	                            this.x + this.entityWidth > scene.entity[entity].x + scene.entity[entity].body.x &&
	                            this.y < scene.entity[entity].y + scene.entity[entity].body.y + scene.entity[entity].body.height &&
	                            this.y + this.entityHeight > scene.entity[entity].y + scene.entity[entity].body.y;
	                        var bottom = this.x < scene.entity[entity].x + scene.entity[entity].body.x + scene.entity[entity].body.width &&
	                            this.x + this.entityWidth > scene.entity[entity].x + scene.entity[entity].body.x &&
	                            this.y < scene.entity[entity].y + scene.entity[entity].body.y + scene.entity[entity].body.height &&
	                            this.y + this.entityHeight > scene.entity[entity].y + scene.entity[entity].body.height + 1;
	                        var right = this.x < scene.entity[entity].x + scene.entity[entity].body.x + scene.entity[entity].body.width &&
	                        ...
	                        var top = this.x < scene.entity[entity].x + (scene.entity[entity].entityWidth * scene.entity[entity].scale) &&
	                            ...
	                            this.y + this.entityHeight > scene.entity[entity].y;
	                        var left = this.x < scene.entity[entity].x + (scene.entity[entity].scale) &&
	                            this.x + this.entityWidth > scene.entity[entity].x &&
	                            this.y < scene.entity[entity].y + (scene.entity[entity].entityHeight * scene.entity[entity].scale) &&
	                            this.y + this.entityHeight > scene.entity[entity].y;
	                        var bottom = this.x < scene.entity[entity].x + (scene.entity[entity].entityWidth * scene.entity[entity].scale) &&
	                        ...
	                        var right = this.x < scene.entity[entity].x + (scene.entity[entity].entityWidth * scene.entity[entity].scale) - (scene.entity[entity].scale) &&
	                            this.x + this.entityWidth > scene.entity[entity].x + (scene.entity[entity].entityWidth * scene.entity[entity].scale) &&
	                            this.y < scene.entity[entity].y + (scene.entity[entity].entityHeight * scene.entity[entity].scale) &&
	                            this.y + this.entityHeight > scene.entity[entity].y;
	        ...
	        try {
	            for (var _b = tslib_1.__values(this.plugins), _c = _b.next(); !_c.done; _c = _b.next()) {
	                var plugin = _c.value;
	                if (entity instanceof Entity.Camera && entityName === "@camera")
	            ...
	            return tslib_1.__generator(this, function (_c) {
	                switch (_c.label) {
	                    ...
	                    case 2:
	                        ...
	                        update = function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
	                            var _a, _b, plugin;
	                            var e_4, _c;
	                            return tslib_1.__generator(this, function (_d) {
	                                switch (_d.label) {
	                                    ...
	                                    case 1:
	                                        _d.sent();
	                                        try {
	                                            for (_a = tslib_1.__values(this.plugins), _b = _a.next(); !_b.done; _b = _a.next()) {
	                                                plugin = _b.value;
	        ...
	        if (entityName in this.saveObject[sceneId]) {
	            ...
	            if (o_1 instanceof HTMLImageElement) {
	                if ("sprit" in entity) {
	                    ...
	                    entity.positions.forEach(function (_a) {
	                ...
	                if ("replaced" in entity)
	                    tslib_1.__spread([["", ""]], entity.replaced).forEach(function (arr) {
	                        text_1 = text_1.replace.apply(text_1, tslib_1.__spread(arr)).replace(/\*[a-z0-9_]+/i, function (result) { return result.slice(1) in entity ? entity[result.slice(1)] : result; });
	                    });
	    ...
	    Game.prototype.update = function (o, sceneId) {
	        return tslib_1.__awaiter(this, void 0, void 0, function () {
	            ...
	            return tslib_1.__generator(this, function (_k) {
	                ...
	                try {
	                    for (_c = tslib_1.__values(Object.keys(this.saveObject[sceneId]).filter(function (n) { return n !== "@camera"; }).sort(function (a, b) { return _this.saveObject[sceneId][a].index - _this.saveObject[sceneId][b].index; })), _d = _c.next(); !_d.done; _d = _c.next()) {
	                        entityName = _d.value;
	                        try {
	                            for (_e = (e_9 = void 0, tslib_1.__values(this.plugins)), _f = _e.next(); !_f.done; _f = _e.next()) {
	                                plugin = _f.value;
