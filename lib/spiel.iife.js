var Spiel = (function (exports) {
	...
	***************************************************************************** */
	...
	var InvisibleClass = /** @class */ (function () {
	    ...
	    InvisibleClass.prototype.tick = function (fn, tick) {
	        if (this.nTick++ < tick) {
	            fn();
	            this.nTick = 0;
	        }
	            ...
	            var intervalFunction = function () {
	                if (self.startOut <= Math.trunc((Date.now()))) {
	                    ...
	                    if (++self.iout < n) {
	                        ...
	                        clearInterval(interval + (self.iout = 0));
	                }
	            };
	            var interval = setInterval(intervalFunction, 1);
	        };
	...
	(function (Entity) {
	    var Image = /** @class */ (function () {
	        ...
	        Image.prototype.timeout = function (fn, time, n) { };
	    ...
	    var Camera = /** @class */ (function () {
	        ...
	        Camera.prototype.timeout = function (fn, time, n) { };
