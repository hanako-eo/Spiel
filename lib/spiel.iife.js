var Spiel = (function (exports) {
	...
	***************************************************************************** */
	...
	var Key = /** @class */ (function () {
	    function Key(key, date) {
	        var _this = this;
	        this.key = key;
	        this.date = date;
	        this.tick = 0;
	        EventEmitter_1.default.on("key:tick-increment", function () { return _this.tick++; });
	    }
	    Key.prototype.getKey = function () {
	        return this.key;
	    };
	    Key.prototype.getTime = function () {
	        return Date.now() - this.date;
	    };
	    Key.prototype.getTick = function () {
	        return this.tick;
	    };
	    return Key;
	}());
	...
	var KeyManager_1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });

	var Key_1 = tslib_es6.__importDefault(Key_1$1);
	var KeyManager = /** @class */ (function () {
	    function KeyManager() {
	        this.keys = {};
	    }
	    KeyManager.prototype.add = function (key) {
	        if (!this.has(key))
	            this.keys[key] = new Key_1.default(key, Date.now());
	    };
	    KeyManager.prototype.remove = function (key) {
	        delete this.keys[key];
	    };
	    KeyManager.prototype.has = function (key) {
	        return key in this.keys;
	    };
	    KeyManager.prototype.getKey = function (key) {
	        if (!this.has(key))
	            return null;
	        return this.keys[key];
	    };
	    KeyManager.prototype.clear = function () {
	        this.keys = {};
	    };
	    return KeyManager;
	}());
	...
	var KeyManager_1$1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var KeyManager_1 = tslib_es6.__importDefault(KeyManager_1$1);
	...
	var Game = /** @class */ (function () {
	    function Game(o, w, h) {
	        ...
	        this.fps = 60;
	        this.state = {};
	        this.key = new KeyManager_1.default();
	        this.audio = {};
	        this.saveObject = {};
	        this.load = {};
	        this.camera = {};
	    ...
	    Game.prototype.setEntity = function (o, scene, entityName, l) {
	        ...
	        if (!(entity instanceof Entity.Camera) && entityName !== "@camera") {
	            entity.on = function (event, fn) {
	                var _a;
	                _this.onTarget[entityName] = (_a = {}, _a[event] = fn, _a);
	            };
	            entity.off = function (event) {
	                if (entityName in _this.onTarget)
	                    delete _this.onTarget[entityName][event];
	            };
	            entity.changeScene = function (name) {
	                _this.sceneId = _this.scenes.findIndex(function (scene) { return scene.name === name; });
	                if (_this.sceneId !== -1) {
	                    if ("toScene" in _this.scenes[_this.sceneId] === false || _this.scenes[_this.sceneId].toScene(_this.use)) {
	    ...
	    Game.prototype.start = function (o) {
	        ...
	        window.onkeyup = function (ev) { return _this.key.remove([ev.ctrlKey || ev.key === "Control" ? "Ctrl" : null, ev.altKey || ev.key === "Alt" ? "Alt" : null, ev.shiftKey || ev.key === "Shift" ? "Shift" : null, ev.key === "Control" || ev.key === "Alt" || ev.key === "Shift" ? null : ev.key === "Deconste" ? "Del" : ev.key === " " ? "Space" : ev.key]
	            .filter(function (keys) { return keys !== null; })
	            .join("+")); };
	        var on = function (event, ev) {
	            for (var entityName in _this.onTarget) {
	                if (event in _this.onTarget[entityName]) {
	                    if ((_this.saveObject[_this.sceneId][entityName].x <= ev.offsetX && (_this.saveObject[_this.sceneId][entityName].x + _this.saveObject[_this.sceneId][entityName].entityWidth) >= ev.offsetX) && (_this.saveObject[_this.sceneId][entityName].y <= ev.offsetY && (_this.saveObject[_this.sceneId][entityName].y + _this.saveObject[_this.sceneId][entityName].entityWidth) >= ev.offsetY))
	                        _this.onTarget[entityName][event]();
	                }
	            }
	        };
	        this.canvas.onmouseover = function (ev) { return on("hover", ev); };
	        this.canvas.onclick = function (ev) { return on("click", ev); };
	        if (this.sceneId !== -1)
	    ...
	    Game.prototype.update = function (o, sceneId) {
	        ...
	        for (var _i = 0, _a = Object.keys(this.saveObject[sceneId]).filter(function (n) { return n !== "@camera"; }).sort(function (a, b) { return _this.saveObject[sceneId][a].index - _this.saveObject[sceneId][b].index; }); _i < _a.length; _i++) {
