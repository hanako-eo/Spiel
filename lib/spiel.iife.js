var Spiel = (function (exports) {
	...
	***************************************************************************** */
	...
	var isClass = function (fn) { return /^\s*class/.test(fn.toString()); };
	function ex(Class) {
	    var args = [];
	        ...
	        if (entityName in this.load) {
	            ...
	            if (o instanceof HTMLImageElement) {
	                ...
	                if ("replaced" in this.saveObject[sceneId][entityName])
	                    tslib_1.__spreadArrays([["", ""]], this.saveObject[sceneId][entityName].replaced).forEach(function (arr) {
	                ...
	                this.context.fillText(text_1, this.saveObject[sceneId][entityName].x + (this.camera[sceneId] === undefined ? 0 : this.camera[sceneId].x), this.saveObject[sceneId][entityName].y + (this.camera[sceneId] === undefined ? 0 : this.camera[sceneId].y));
	            }
	        }
	    };
