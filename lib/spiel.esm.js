...
var Plugin = /** @class */ (function () {
    ...
    Plugin.prototype.getKeys = function (key) { };
    ...
    Game.prototype.start = function (o) {
        ...
        if (this.sceneId !== -1) {
            ...
            window.onkeydown = function (ev) {
                ...
                for (var _i = 0, _a = _this.plugins; _i < _a.length; _i++) {
                    var plugin = _a[_i];
                    plugin.getKeys(_this.key);
                }
            };
            window.onkeyup = function (ev) {
                _this.key.remove([ev.ctrlKey || ev.key === "Control" ? "Ctrl" : null, ev.altKey || ev.key === "Alt" ? "Alt" : null, ev.shiftKey || ev.key === "Shift" ? "Shift" : null, ev.key === "Control" || ev.key === "Alt" || ev.key === "Shift" ? null : ev.key === "Deconste" ? "Del" : ev.key === " " ? "Space" : ev.key]
                    .filter(function (keys) { return keys !== null; })
                    .join("+"));
                for (var _i = 0, _a = _this.plugins; _i < _a.length; _i++) {
                    var plugin = _a[_i];
