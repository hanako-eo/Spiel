var Spiel = (function (exports) {
	...
	***************************************************************************** */
	...
	var Plugin = /** @class */ (function () {
	    ...
	    Plugin.prototype.sceneUpdate = function (entities, sceneName, timestamp) { };
	...
	var FPSPlugin = /** @class */ (function (_super) {
	    ...
	    FPSPlugin.prototype.sceneUpdate = function (_, __, timestamp) {
	            ...
	            return tslib_es6.__generator(this, function (_c) {
	                switch (_c.label) {
	                    ...
	                    case 2:
	                        ...
	                        update = function (timestamp) { return tslib_es6.__awaiter(_this, void 0, void 0, function () {
	                            var _a, _b, plugin;
	                            var e_4, _c;
	                                    ...
	                                    case 1:
	                                        ...
	                                        try {
	                                            for (_a = tslib_es6.__values(this.plugins), _b = _a.next(); !_b.done; _b = _a.next()) {
	                                                plugin = _b.value;
	                                                plugin.sceneUpdate(this.saveObject[sceneId], this.use, timestamp);
	                                            }
	                                        }
