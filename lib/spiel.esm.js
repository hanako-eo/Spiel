...
var Game = /** @class */ (function () {
        ...
        if (entityName in this.saveObject[sceneId]) {
            ...
            if (o_1 instanceof HTMLImageElement) {
                ...
                if ("replaced" in this.saveObject[sceneId][entityName])
                    tslib_es6.__spread([["", ""]], this.saveObject[sceneId][entityName].replaced).forEach(function (arr) {
                        text_1 = text_1.replace.apply(text_1, tslib_es6.__spread(arr)).replace(/\*[a-z0-9_]+/i, function (result) { return result.slice(1) in _this.saveObject[sceneId][entityName] ? _this.saveObject[sceneId][entityName][result.slice(1)] : result; });
                    });
    ...
    Game.prototype.update = function (o, sceneId) {
        ...
        if (this.camera[sceneId] !== undefined) {
            ...
            this.drawCamera(sceneId);
            try {
                for (var _d = tslib_es6.__values(this.plugins), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var plugin = _e.value;
        ...
        try {
            for (var _f = tslib_es6.__values(Object.keys(this.saveObject[sceneId]).filter(function (n) { return n !== "@camera"; }).sort(function (a, b) { return _this.saveObject[sceneId][a].index - _this.saveObject[sceneId][b].index; })), _g = _f.next(); !_g.done; _g = _f.next()) {
                var entityName = _g.value;
                try {
                    for (var _h = (e_9 = void 0, tslib_es6.__values(this.plugins)), _j = _h.next(); !_j.done; _j = _h.next()) {
                        var plugin = _j.value;
...
export { app_3 as Entity, app_5 as Game, app_2 as Loader, app_4 as Plugin, app_1 as ex };
